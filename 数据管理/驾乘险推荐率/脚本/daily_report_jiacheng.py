...
# 配置
SCRIPT_DIR = Path(__file__).parent.parent  # 指向驾乘险推荐率文件夹
CONFIG = {
    'data_path': Path('/Users/alongor666/Downloads/底层数据湖DUD/chexian-api/数据管理/warehouse/fact/policy/current'),
...
def main():
    ...
    try:
        ...
        output_file = output_dir / f"驾乘险推介率日报_{latest_date.strftime('%Y-%m-%d')}.md"
