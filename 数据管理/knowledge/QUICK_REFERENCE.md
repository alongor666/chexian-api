...
**更新**: 2026-05-20 | **数据规模**: ~257 万条 / 42 字段 | **分片**: 11 个 Parquet（policy/current/）

## 数据规模（三层口径）

| 口径 | 数值 | 说明 |
|------|------|------|
| 原始记录 | ~257 万行 | policy/current UNION ALL 行数 |
| 唯一保单 | ~250 万 | COUNT DISTINCT policy_no |
| 2024+ 活跃 | ~123 万行 | policy_date >= 2024-01-01 |
