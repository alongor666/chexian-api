...
**更新**: 2026-07-07 | **数据规模**: ~631 万条 / 48 字段 | **分片**: 7 个 Parquet（policy/current/）

## 数据规模（三层口径）

| 口径 | 数值 | 说明 |
|------|------|------|
| 原始记录 | ~631 万行 | policy/current UNION ALL 行数 |
| 唯一保单 | ~434 万 | COUNT DISTINCT policy_no |
| 2024+ 活跃 | ~255 万行 | policy_date >= 2024-01-01 |
