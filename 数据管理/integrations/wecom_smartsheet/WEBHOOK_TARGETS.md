...
| `shanxi_taiyuan2_renweijun` | 太原二部任卫军「业务台账」 | `.env.local:WECOM_SMARTSHEET_WEBHOOK_TY2_RENWEIJUN` | `state/shanxi-taiyuan2-renweijun_synced_keys.json` | `instances/shanxi-taiyuan2-renweijun.yaml` | 增量 add-only；2026-01-01 起 7 字段（出单日期/保单号/车牌号/保费/险种大类/客户类别/上年保险公司）；省份隔离 branch_code='SX' + 业务员=118046126任卫军 | 业务员/投保人为 user 型不写入（投保人改文本型后可启用 applicant_name 映射）；手机号码业务员自填 |
