...
export const agentToolRegistry = AgentToolDefinitionSchema.array().parse([
  ...
  { id: 'customer_flow.summary', status: 'available', endpoint: '/api/query/customer-flow/summary', capabilityId: 'customer_flow_diagnosis', metrics: ['customer_inflow', 'customer_outflow'] },
