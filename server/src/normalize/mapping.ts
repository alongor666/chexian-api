...
export const COLUMN_ALIASES: ColumnAliasConfig = {
  ...
  customer_category: ['customer_category', 'customerCategory', '客户类别', 'customer_type', 'client_category'],
  insurance_type: ['insurance_type', 'insuranceType', '险类', 'insurance_class', 'product_type'],
  ...
  is_nev: ['is_nev', 'isNev', '是否新能源', '新能源', 'new_energy_vehicle', 'nev'],
  is_telemarketing: ['is_telemarketing', 'isTelemarketing', '是否电销', '电销', 'telemarketing', 'telesales'],
  tonnage_segment: ['tonnage_segment', 'tonnageSegment', '吨位分段', 'tonnage', 'weight_segment'],
  renewal_policy_no: [
    '续保单号',
    'renewal_policy_no',
    'renewalPolicyNo',
