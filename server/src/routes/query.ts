...
import { rejectUnknownRegisteredQueryParams } from '../middleware/query-param-contract.js';
...
import salesTeamPerformanceRoutes from './query/sales-team-performance.js';
...
router.use(rejectUnknownRegisteredQueryParams);
...
router.use(salesTeamPerformanceRoutes);
