...
**Plans:** 3 plans
Plans:
- [x] 02-01-PLAN.md — SQL-01 黄金快照基线（golden-baseline.mjs + 66 端点存档）
- [x] 02-02-PLAN.md — SQL-02 后端系数删除（formatDate 迁移 + 5 个文件删除 + query.ts 清理）
- [x] 02-03-PLAN.md — SQL-02 前端系数删除 + SQL-03 书面结论（ORG_GROUPS 迁移 + 全链路清理）
