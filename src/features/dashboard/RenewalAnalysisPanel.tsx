...
import { cardStyles, textStyles, colorClasses, cn, fontStyles } from '../../shared/styles';
                ...
                {detailData.map((row, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className={cn("px-3 py-2 text-right border-r", fontStyles.numeric, colorClasses.border.neutral)}>{valueFormatter(row.month_to_date_due_count)}</td>
                      <td className={cn("px-3 py-2 text-right border-r", fontStyles.numeric, colorClasses.border.neutral)}>{valueFormatter(row.month_to_date_renewed_count)}</td>
                      <td className={cn("px-3 py-2 border-r-2 text-center", colorClasses.border.neutral)}>
                        <RenewalStatusBadge rate={row.monthly_renewal_rate} mode="dot" size="small" />
                      </td>
                      <td className={cn("px-3 py-2 text-right border-r", fontStyles.numeric, colorClasses.border.neutral)}>{valueFormatter(row.year_to_date_due_count)}</td>
                      <td className={cn("px-3 py-2 text-right border-r", fontStyles.numeric, colorClasses.border.neutral)}>{valueFormatter(row.year_to_date_renewed_count)}</td>
