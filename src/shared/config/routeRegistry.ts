...
export const ROUTES: readonly RouteDefinition[] = [
  ...
  { kind: 'canonical', id: 'cost', path: '/cost', label: '成本分析', shortLabel: '成本', iconKey: 'calculator', navigationDomain: 'cost', navigationOrder: 10, showInNavigation: true, permissionConfigurable: true, aliases: ['/comprehensive-analysis'] },
  { kind: 'canonical', id: 'claims-detail', path: '/claims-detail', label: '赔案分析', shortLabel: '赔案', iconKey: 'file-warning', navigationDomain: 'cost', navigationOrder: 20, showInNavigation: true, permissionConfigurable: true },
  { kind: 'canonical', id: 'expense-development', path: '/expense-development', label: '费用率发展', shortLabel: '费发', iconKey: 'trending-down', navigationDomain: 'cost', navigationOrder: 30, showInNavigation: true, permissionConfigurable: true, specialFeature: 'expense_development' },
  ...
  { kind: 'canonical', id: 'quote-conversion', path: '/quote-conversion', label: '报价转化', shortLabel: '报价', iconKey: 'target', navigationDomain: 'customer', navigationOrder: 20, showInNavigation: true, permissionConfigurable: true },
  { kind: 'canonical', id: 'customer-flow', path: '/customer-flow', label: '客户流向', shortLabel: '流向', iconKey: 'arrow-left-right', navigationDomain: 'customer', navigationOrder: 30, showInNavigation: true, permissionConfigurable: true },
  ...
  { kind: 'canonical', id: 'repair', path: '/repair', label: '维修资源', shortLabel: '维修', iconKey: 'wrench', navigationDomain: 'specialty', navigationOrder: 20, showInNavigation: true, permissionConfigurable: true },
