...
// policy_no 前 3 位必须是 '610'（field-registry branch_code prefix_map 唯一映射到 SC，
// 见 server/src/config/field-registry/fields.json branch_code.derivation.mapping），
// 否则 transform.py 的 strictNonNull fail-fast 会因未命中前缀而 sys.exit(1)。
const FIXTURE_ROWS = [
  ['天府', '610P0001', '', '', '', '2026-03-09', '2026-03-09', '2026-03-20', '非营业个人客车', 0, '否', '否', '否', '非套单', '交三', '车型A', 5, '川A01', '10001张三', '经代A', '直客', '柜面', '商业保险', 1000, 1.0, '', '否', 'VIN-001', 0, 0, 0],
  ['天府', '610P0001', '', '', '', '2026-03-10', '2026-03-10', '2026-03-21', '非营业个人客车', 0, '否', '否', '否', '非套单', '交三', '车型A', 5, '川A01', '10001张三', '经代A', '直客', '柜面', '商业保险', 500, 1.0, '', '否', 'VIN-001', 0, 0, 0],
  ['天府', '610P0003', '', '', '', '2026-03-10', '2026-03-10', '2026-03-22', '非营业个人客车', 0, '否', '否', '否', '非套单', '交三', '车型C', 5, '川A03', '10003王五', '经代C', '直客', '柜面', '商业保险', -200, 1.0, '16退保', '否', 'VIN-003', 0, 0, 0],
  ['天府', '610P0002', '', '', '', '2026-03-10', '2026-03-10', '2026-03-25', '营业货车', 0, '否', '否', '否', '非套单', '主全', '车型B', 2, '川A02', '10002李四', '经代B', '转介绍', '柜面', '商业保险', 2000, 1.0, '', '否', 'VIN-002', 0, 0, 0],
];
